...
./Sources/gsc_scheduler/gsc_sch_core/gsc_sch_interrupts.d \
...
Sources/gsc_scheduler/gsc_sch_core/gsc_sch_interrupts.o: ../Sources/gsc_scheduler/gsc_sch_core/gsc_sch_interrupts.c
	@echo 'Building file: $<'
	@echo 'Executing target #11 $<'
	@echo 'Invoking: ARM Ltd Windows GCC C Compiler'
	"$(ARMSourceryDirEnv)/arm-none-eabi-gcc" "$<" @"Sources/gsc_scheduler/gsc_sch_core/gsc_sch_interrupts.args" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/gsc_scheduler/gsc_sch_core/gsc_sch_interrupts.o"
	@echo 'Finished building: $<'
	@echo ' '
