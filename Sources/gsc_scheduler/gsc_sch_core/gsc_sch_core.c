...
/*  1.2      | 14/apr/2014 |                               | MDRR             */
/* Created functions to work as interfaces for rt_curOpMode                   */
/*============================================================================*/
...
volatile T_OpModeType rt_curOpMode = NORMAL_MODE; 
 ...
 *  Postcondition        :  No.
 **************************************************************/
void gsc_sch_core_SetMode(T_OpModeType lt_NewMode)
{
	rt_curOpMode = lt_NewMode;
}
 ...
 *  Postcondition        :  No.
 **************************************************************/
T_OpModeType gsc_sch_core_GetMode(void)
{
	return rt_curOpMode;
}
